...
?>
    ...
    <section class="products">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php 
                     ...
                     $sorgu=$db->prepare("select * from satis where satis_onay=1");
                     $sorgu->execute();
        ...
        $satissor=$db->prepare("SELECT * FROM satis where satis_onay=1 order by satis_id DESC limit $limit,$sayfada");
        $satissor->execute();
